...
import type { DOMAttributes, LongPressEvent, Node, PressEvent } from "@react-types/shared";
import type { ButtonHTMLAttributes, Key, KeyboardEventHandler, RefObject } from "react";
...
/**
 * @deprecated use useReactAriaAccordionItem instead from ../use-aria-accordion
 */
