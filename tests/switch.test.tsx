...
import { Switch } from "@/registry/ui";
...
describe("Switch", () => {
  ...
  it("should render the thumbIcon", () => {
    const wrapper = render(<Switch aria-label="switch" thumbIcon={<svg data-testid="thumb-icon" />} />);
  ...
  it("should change the thumbIcon when clicked", async () => {
    const thumbIcon = jest.fn((props) => {
      ...
      return isSelected ? <svg data-testid="checked-thumb-icon" /> : <svg data-testid="unchecked-thumb-icon" />;
    });
  ...
  it('should work with "startContent"', () => {
    const wrapper = render(<Switch aria-label="switch" startContent={<svg data-testid="start-icon" />} />);

    expect(wrapper.getByTestId("start-icon")).toBeInTheDocument();
  });

  it('should work with "endContent"', () => {
    const wrapper = render(<Switch aria-label="switch" endContent={<svg data-testid="end-icon" />} />);
